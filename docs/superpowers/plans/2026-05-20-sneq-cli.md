...
- **Hermes integration**: not in this plan. Once the CLI lands, the agent's Hermes runtime can shell out via `child_process.execFile`. That work belongs to her repo, not this one.
